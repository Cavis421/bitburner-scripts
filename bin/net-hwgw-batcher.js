 ...
 *   run /bin/net-hwgw-batcher.js <target>


 *   run /bin/net-hwgw-batcher.js --help
...
function printHelp(ns) {
    ...
    const script = "/bin/net-hwgw-batcher.js";
    ...
    ns.tprint("  run /bin/net-hwgw-batcher.js");


    ns.tprint("  run /bin/net-hwgw-batcher.js <target>");


    ns.tprint("  run /bin/net-hwgw-batcher.js --help");
