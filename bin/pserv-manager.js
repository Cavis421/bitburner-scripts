...
export async function main(ns) {
    ...
    ns.tprint("ðŸ–¥ï¸ pserv-manager started.");
    ...
    while (true) {
        ...
        if (servers.length < limit) {
            ...
            if (cost > budget || cost > money) {
                ...
                ns.print(
                    ...
                    `ðŸ’¸ Not enough funds to buy new ${purchaseRam}GB pserv. ` +
            ...
            if (result) {
                ...
                ns.tprint(
                    ...
                    `ðŸ–¥ï¸ Purchased ${newName} with ${purchaseRam}GB ` +
        ...
        if (cost > money) {
            ...
            ns.print(
                ...
                `ðŸ’¸ Not enough funds to reach tier ${targetRam}GB. ` +
        ...
        if (upgradeCandidates.length === 0) {
            ...
            ns.print(
                ...
                `ðŸ“ˆ All servers are at or above current target tier (${targetRam}GB). ` +
        ...
        if (cost > money) {
            ...
            ns.print(
                ...
                `ðŸ’¸ Not enough money to upgrade ${weakest.name} ` +
