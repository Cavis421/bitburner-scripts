...
export async function main(ns) {
    ...
    if (!target) {
        ...
        ns.tprint("No batch target provided. /bin/timed-net-batcher.js requires a target server.");
        ...
        ns.tprint("  run /bin/timed-net-batcher.js <target>");
        ...
        ns.tprint("  run /bin/timed-net-batcher.js n00dles");
 ...
 * Help text for /bin/timed-net-batcher.js
...
function printHelp(ns) {
    ...
    ns.tprint("/bin/timed-net-batcher.js");
    ...
    ns.tprint("  run /bin/timed-net-batcher.js <target> [--help]");
    ...
    ns.tprint("  run /bin/timed-net-batcher.js omega-net");
