 ...
 *  “early daemon” running (default: botnet/botnet-hgw-sync.js).
 *
 * Notes
 ...
 *  - By default, early daemon is stopped right before starting core/controller.js
 *    to help meet the free-RAM gate.
 *
 * Syntax
 *  run core/bootstrap.js
 *  run core/bootstrap.js --controllerRam 700 --poll 5000
 *  run core/bootstrap.js --early botnet/botnet-hgw-sync.js -- n00dles money
 *  run core/bootstrap.js --early core/early-hack.js -- n00dles
 *  run core/bootstrap.js --stopEarly false
...
const FLAGS = [
  ...
  ["early", "botnet/botnet-hgw-sync.js"], // set "" to disable
  ["earlyThreads", 1],
...
export async function main(ns) {
  ...
  // Example: run core/bootstrap.js -- n00dles money
...
function printHelp(ns) {
  ...
  ns.tprint("  While waiting, it can keep a lightweight early daemon running (default: botnet/botnet-hgw-sync.js).");
  ns.tprint("");
  ns.tprint("Notes");
  ...
  ns.tprint('  run core/bootstrap.js --early botnet/botnet-hgw-sync.js -- n00dles money');
  ns.tprint('  run core/bootstrap.js --early core/early-hack.js -- n00dles');
  ns.tprint("  run core/bootstrap.js --stopEarly false");
