 ...
 *
 * Usage:
 *   run core/early-backdoor-helper.js
 *   run core/early-backdoor-helper.js --help
 *
 * @param {NS} ns
 */
...
function printHelp(ns) {
    const script = "core/early-backdoor-helper.js";
    ...
    // SYNTAX
    ns.tprint("SYNTAX");
    ns.tprint("  run core/early-backdoor-helper.js");
    ns.tprint("  run core/early-backdoor-helper.js --help");
    ns.tprint("");
