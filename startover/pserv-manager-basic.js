...
export async function main(ns) {
    ...
    // Max RAM you ultimately want per server (default 32 GB, capped as requested)
    const maxDesiredRam = Number(ns.args[0] ?? 32);
    ...
    ns.tprint(`🧠 pserv-manager-basic started. Target max RAM: ${maxDesiredRam}GB`);
