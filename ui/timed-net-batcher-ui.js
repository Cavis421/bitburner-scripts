...
export async function main(ns) {
  ...
  const weakScript = "batch/batch-weaken.js";

  // Copy of your defaults (for display + “PREP vs MONEY” logic)
...
function getSnapshot(ns, cfg) {
  ...
  // Detect “active targets” from worker args: [target, delay, ...]
  ...
  // (Your controller does hysteresis; UI just shows the “likely mode”.)
