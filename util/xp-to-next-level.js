 ...
 *   - Optional: util/xp-throughput.txt (written by ui/xp-throughput-monitor.js) for XP/sec estimate.
...
function printHelp(ns) {
    ns.tprint("");
    ns.tprint("util/xp-to-next-level.js");
    ns.tprint("=======================================");
    ...
    ns.tprint("  --no-file         Ignore util/xp-throughput.txt and always do local sampling.");
    ns.tprint("");
    ns.tprint("Notes:");
