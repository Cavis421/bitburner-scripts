...
function printHelp(ns) {
  ...
  ns.tprint("");
  ns.tprint("Syntax");
  ns.tprint("  run wse/basic-trader.js");
  ns.tprint("  run wse/basic-trader.js --heartbeat 30");
  ns.tprint("  run wse/basic-trader.js --heartbeat 0      # disable heartbeat");
  ns.tprint("  run wse/basic-trader.js --long-enter 0.58  # more active");
  ns.tprint("  run wse/basic-trader.js --help");
}
